...
(function(window, document) {
    ...
    class StandardPatch {
        ...
        validatePatch(file) {
            ...
            if (status === "on") {
                ...
                return '"' + this.name + '" 沒有對齊 ! 你放入的好像不是正確檔案？';
            }
        }
    ...
    var loadPatch = function(_this, self, patcher) {
        ...
        self.successDiv.innerHTML = successStr + " 檔案讀取成功!!";
    };
    ...
    class PatchContainer {
        ...
        createUI() {
            ...
            label.innerHTML = "<strong>選擇檔案</strong> 或 直接拖移進來.";
            ...
            reader.onload = function(e) {
                ...
                for (var i = 0; i < self.patchers.length; i++) {
                    ...
                    if (patcher.validatePatches()) {
                        ...
                        self.matchSuccessText[i].textContent = ' ' + valid + ' 的 ' + valid + ' 補丁匹配 (100%) ';
                    }
                }
                ...
                if (!found) {
                    ...
                    for (let i = 0; i < self.patchers.length; i++) {
                        ...
                        self.forceLoadTexts[i].textContent = ' ' + valid + ' 的 ' + patcher.totalPatches + ' 補丁匹配 (' + percent + '%) ';
                    ...
                    self.errorDiv.innerHTML = "沒有補丁集是 100% 匹配的.";
                }
            };
